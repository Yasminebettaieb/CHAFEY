...
def get_data(args: argparse.Namespace): 
    ...
    if args.dataset == 'dogs':
        return get_dogs(True, 'E:/WS/CHAFEY/data/dog-breed-identification/trainn', 'E:/WS/CHAFEY/data/dog-breed-identification/trainn', args.image_size, args.seed, args.validation_size)
...
def get_dogs(augment:bool, train_dir:str, project_dir: str, img_size: int, seed:int, validation_size:float):
    shape = (3, img_size, img_size)
    mean = (0.485, 0.456, 0.406)
    std = (0.229, 0.224, 0.225)
    normalize = transforms.Normalize(mean=mean,std=std)
    ...
    return create_datasets(transform1, transform2, transform_no_augment, 3, train_dir, project_dir, None, seed, validation_size,None,None, transform1p)
